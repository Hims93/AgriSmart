                ...
                <div class="col-sm-3">
                  <form action="manage_store.php" method="post">
                    <div class="thumb-wrapper">
                      ...
                      <div class="img-box">
                        <img src="../img/uriya.jpg" class="img-responsive img-fluid" alt="">
                      </div>
                ...
                <div class="col-sm-3">
                  <form action="manage_store.php" method="post">
                    <div class="thumb-wrapper">
                      <span class="wish-icon"><i class="fa fa-heart-o"></i></span>
                      <div class="img-box">
                        <img src="../img/dap.jpg" class="img-responsive img-fluid" alt="">
                      </div>
                      <div class="thumb-content">
                        <h4>D.A.P</h4>
                        <div class="star-rating">
                ...
                <div class="col-sm-3">
                  <form action="manage_store.php" method="post">
                    <div class="thumb-wrapper">
                      <span class="wish-icon"><i class="fa fa-heart-o"></i></span>
                      <div class="img-box">
                        <img src="../img/spreyer.jpg" class="img-responsive img-fluid" alt="">
                      </div>
                      <div class="thumb-content">
                        <h4>Spreyair</h4>
                        <div class="star-rating">
                ...
                <div class="col-sm-3">
                  <form action="manage_store.php" method="post">
                    <div class="thumb-wrapper">
                      <span class="wish-icon"><i class="fa fa-heart-o"></i></span>
                      <div class="img-box">
                        <img src="../img/humiroot.jpg" class="img-responsive img-fluid" alt="">
                      </div>
                      <div class="thumb-content">
                        <h4>Humiroot</h4>
                        <div class="star-rating">
        ...
        <div class="row store-row-2 py-3">
          ...
          <div class="col-sm-3">
            <div class="thumb-wrapper">
              <span class="wish-icon"><i class="fa fa-heart-o"></i></span>
              <div class="img-box">
                <img src="../img/beet.png" class="img-responsive img-fluid" alt="">
              </div>
              <div class="thumb-content">
          ...
          <div class="col-sm-3">
            <div class="thumb-wrapper">
              <span class="wish-icon"><i class="fa fa-heart-o"></i></span>
              <div class="img-box">
                <img src="../img/broccoli.png" class="img-responsive img-fluid" alt="">
              </div>
              <div class="thumb-content">
          ...
          <div class="col-sm-3">
            <div class="thumb-wrapper">
              <span class="wish-icon"><i class="fa fa-heart-o"></i></span>
              <div class="img-box">
                <img src="../img/cabbage_PNG8815.png" class="img-responsive img-fluid" alt="">
              </div>
              <div class="thumb-content">
          ...
          <div class="col-sm-3">
            <div class="thumb-wrapper">
              <span class="wish-icon"><i class="fa fa-heart-o"></i></span>
              <div class="img-box">
                <img src="../img/cabbage_PNG8823.png" class="img-responsive img-fluid" alt="">
              </div>
              <div class="thumb-content">
        ...
        <div class="row store-row-3 py-3">
          ...
          <div class="col-sm-3">
            <div class="thumb-wrapper">
              <span class="wish-icon"><i class="fa fa-heart-o"></i></span>
              <div class="img-box">
                <img src="../img/carrot_PNG4988.png" class="img-responsive img-fluid" alt="">
              </div>
              <div class="thumb-content">
          ...
          <div class="col-sm-3">
            <div class="thumb-wrapper">
              <span class="wish-icon"><i class="fa fa-heart-o"></i></span>
              <div class="img-box">
                <img src="../img/corn_PNG5286.png" class="img-responsive img-fluid" alt="">
              </div>
              <div class="thumb-content">
          ...
          <div class="col-sm-3">
            <div class="thumb-wrapper">
              <span class="wish-icon"><i class="fa fa-heart-o"></i></span>
              <div class="img-box">
                <img src="../img/garlic_PNG12801.png" class="img-responsive img-fluid" alt="">
              </div>
              <div class="thumb-content">
          ...
          <div class="col-sm-3">
            <div class="thumb-wrapper">
              <span class="wish-icon"><i class="fa fa-heart-o"></i></span>
              <div class="img-box">
                <img src="../img/ginger_PNG16800.png" class="img-responsive img-fluid" alt="">
              </div>
              <div class="thumb-content">
        ...
        <div class="row store-row-3 py-3">
          ...
          <div class="col-sm-3">
            <div class="thumb-wrapper">
              <span class="wish-icon"><i class="fa fa-heart-o"></i></span>
              <div class="img-box">
                <img src="../img/mushroom_PNG3219.png" class="img-responsive img-fluid" alt="">
              </div>
              <div class="thumb-content">
          ...
          <div class="col-sm-3">
            <div class="thumb-wrapper">
              <span class="wish-icon"><i class="fa fa-heart-o"></i></span>
              <div class="img-box">
                <img src="../img/onion_PNG3821.png" class="img-responsive img-fluid" alt="">
              </div>
              <div class="thumb-content">
                <h4 class="h4-responsive">Beetroot</h4>
                <div class="star-rating">
          ...
          <div class="col-sm-3">
            <div class="thumb-wrapper">
              <span class="wish-icon"><i class="fa fa-heart-o"></i></span>
              <div class="img-box">
                <img src="../img/palm_tree_PNG93356.png" class="img-responsive img-fluid" alt="">
              </div>
              <div class="thumb-content">
          ...
          <div class="col-sm-3">
            <div class="thumb-wrapper">
              <span class="wish-icon"><i class="fa fa-heart-o"></i></span>
              <div class="img-box">
                <img src="../img/wheat_PNG108.png" class="img-responsive img-fluid" alt="">
              </div>
              <div class="thumb-content">
